...
namespace LightningForge.Arcade.Game.Chess
{
    ...
    /// </summary>
    [RequireComponent(typeof(SquareBoardView))]
    public class ChessGameController : MonoBehaviour
    {
        [SerializeField] SquareBoardView boardView;
        ...
        void Reset()
        {
            boardView = GetComponent<SquareBoardView>();
        }
        ...
        {
            if (boardView == null) boardView = GetComponent<SquareBoardView>();
